...
{
  new (message_memory) mini_pjt_interfaces::msg::RobotState(_init);
}

void RobotState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mini_pjt_interfaces::msg::RobotState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotState_message_member_array[4] = {
  {
    ...
    offsetof(mini_pjt_interfaces::msg::RobotState, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mini_pjt_interfaces::msg::RobotState, state),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mini_pjt_interfaces::msg::RobotState, target_distance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mini_pjt_interfaces::msg::RobotState, arrived),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RobotState_message_members = {
  ...
  4,  // number of fields
  sizeof(mini_pjt_interfaces::msg::RobotState),
...
get_message_type_support_handle<mini_pjt_interfaces::msg::RobotState>()
{
  return &::mini_pjt_interfaces::msg::rosidl_typesupport_introspection_cpp::RobotState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mini_pjt_interfaces, msg, RobotState)() {
  return &::mini_pjt_interfaces::msg::rosidl_typesupport_introspection_cpp::RobotState_message_type_support_handle;
}
