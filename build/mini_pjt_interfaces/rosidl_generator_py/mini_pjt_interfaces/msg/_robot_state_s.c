...
bool mini_pjt_interfaces__msg__robot_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mini_pjt_interfaces.msg._robot_state.RobotState", full_classname_dest, 47) == 0);
  }
  mini_pjt_interfaces__msg__RobotState * ros_message = _ros_message;
  {  // header
...
PyObject * mini_pjt_interfaces__msg__robot_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mini_pjt_interfaces.msg._robot_state");
