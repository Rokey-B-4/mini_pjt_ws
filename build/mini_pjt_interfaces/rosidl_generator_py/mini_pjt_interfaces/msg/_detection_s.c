...
bool mini_pjt_interfaces__msg__detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mini_pjt_interfaces.msg._detection.Detection", full_classname_dest, 44) == 0);
  }
  mini_pjt_interfaces__msg__Detection * ros_message = _ros_message;
  {  // class_name
...
PyObject * mini_pjt_interfaces__msg__detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mini_pjt_interfaces.msg._detection");
  ...
  {  // bbox
    ...
    int32_t * src = &(ros_message->bbox[0]);
