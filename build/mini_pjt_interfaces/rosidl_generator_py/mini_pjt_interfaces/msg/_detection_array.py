    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'mini_pjt_interfaces.msg.DetectionArray')
            logger.debug(
            ...
            from mini_pjt_interfaces.msg import Detection
...
class DetectionArray(metaclass=Metaclass_DetectionArray):
    ...
    _fields_and_field_types = {
        ...
        'detections': 'sequence<mini_pjt_interfaces/Detection>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['mini_pjt_interfaces', 'msg'], 'Detection')),  # noqa: E501
    )
