...
#include "mini_pjt_interfaces/msg/detail/robot_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mini_pjt_interfaces::msg::RobotState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mini_pjt_interfaces::msg::RobotState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mini_pjt_interfaces::msg::RobotState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mini_pjt_interfaces::msg::RobotState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mini_pjt_interfaces::msg::RobotState *>(
    untyped_ros_message);
...
{
  return &mini_pjt_interfaces::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mini_pjt_interfaces, msg, RobotState)() {
  return &mini_pjt_interfaces::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
